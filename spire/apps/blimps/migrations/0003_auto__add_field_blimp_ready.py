...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blimp.ready'
        db.add_column('blimps_blimp', 'ready',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blimp.ready'
        db.delete_column('blimps_blimp', 'ready')
    ...
    models = {
        ...
        'blimps.blimp': {
            ...
            'port': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True', 'default': 'None'}),
